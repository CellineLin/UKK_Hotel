...
--
CREATE TABLE `sequelizemeta` (`name` varchar(255) NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci;
...
ALTER TABLE
    `detail_pemesanans`
ADD
    CONSTRAINT `detail_pemesanans_ibfk_1` FOREIGN KEY (`id_pemesanan`) REFERENCES `pemesanans` (`id`);
...
ALTER TABLE
    `kamars`
ADD
    CONSTRAINT `kamars_ibfk_1` FOREIGN KEY (`id_tipe_kamar`) REFERENCES `tipe_kamars` (`id`);
...
ALTER TABLE
    `pemesanans`
ADD
    CONSTRAINT `pemesanans_ibfk_1` FOREIGN KEY (`id_tipe_kamar`) REFERENCES `tipe_kamars` (`id`),
ADD
    CONSTRAINT `pemesanans_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`);
